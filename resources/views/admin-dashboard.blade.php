            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                ...
                <div class="bg-gray-800/50 border border-gray-700 rounded-2xl p-6 backdrop-blur-sm">
                    ...
                    <h3 class="text-4xl font-black text-rose-500">
                        {{ auth()->user()->total_dette }} <span class="text-lg font-normal">MAD</span>
                    </h3>
                </div>
            </div>
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <div class="bg-gray-800/40 border border-gray-700 rounded-2xl overflow-hidden">
                            <div class="divide-y divide-gray-700/50 max-h-[300px] overflow-y-auto">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-white mb-4">Toutes votre Colocations</h2>
                        <div class="bg-gray-800/40 border border-gray-700 rounded-2xl overflow-hidden">
                            <div class="divide-y divide-gray-700/50 max-h-[300px] overflow-y-auto">
                                ...
                                @empty
                                    <div class="p-8 text-center">
                                        <p class="text-gray-600 italic text-sm">Vous appartenir a aucune colocation</p>
                                    </div>
                                @endforelse
                            </div>
                        </div>
